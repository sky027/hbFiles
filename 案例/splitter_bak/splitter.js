...
(function($) {
    ...
    $.fn.splitter = function(args) {
        ...
        return this.each(function() {
            ...
            if (opts.closeableto != undefined) {
            	...
            	if ($(this).data('Bt')) {
            		...
            		Bt.mousedown(function(e) {
            		    ...
            		    splitTo((splitPos == opts.closeableto) ? _splitPos : opts.closeableto, true, false);
            ...
            perc = opts.reverse ? 100 - perc : perc;
            splitTo(perc, false, true);

            // resize  event handlers;
            splitter.unbind("resize").bind("resize", function(e, size) {
                if (e.target != this) return;
                splitTo(splitPos, false, true);
            });
            $(window).unbind("resize").bind("resize", function() { splitTo(splitPos, false, true); });
